...
const segments: GuideItinerarySegment[] = [
  ...
  },
  {
    ...
    verifiedRoutes: [
      ...
      { dayNumber: 10, title: '宏村与卢村', summary: '宏村、南湖与周边步行；卢村观景点。', linkedSpots: ['宏村', '南湖', '卢村'], status: 'visited' },
      { dayNumber: 11, title: '塔川入口与古村秋色', summary: '塔川入口区域与周边慢行。', linkedSpots: ['塔川'], status: 'visited' },
    ],
