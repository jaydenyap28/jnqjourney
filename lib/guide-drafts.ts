...
const segments: GuideItinerarySegment[] = [
  {
    ...
    accommodation: '唯庭世纪酒店（静安区）', accommodationSpotName: '唯庭世纪酒店',
  ...
  },
  {
    ...
    accommodation: '花筑·同里古镇懿园园林客栈', accommodationSpotName: '花筑·同里古镇懿园园林客栈',
  ...
  },
  {
    ...
    accommodation: '灵水居', accommodationSpotName: '灵水居',
  ...
  },
  {
    ...
    accommodation: '祺悦西湖文化酒店（杭州西湖湖滨银泰店）', accommodationSpotName: '祺悦西湖文化酒店(杭州西湖湖滨银泰店)',
  ...
  },
  {
    ...
    verifiedRoutes: [
      ...
      { dayNumber: 10, title: '宏村、卢村与碧山村', summary: '宏村、南湖与周边步行；卢村观景点与碧山村。', linkedSpots: ['宏村', '南湖', '卢村', '碧山村'], status: 'visited' },
      { dayNumber: 11, title: '塔川入口、秀里水镇与古村秋色', summary: '塔川入口区域、秀里水镇与周边慢行。', linkedSpots: ['塔川', '秀里水镇'], status: 'visited' },
    ],
    referenceRoutes: [{ title: '附近延伸选择', summary: '奇墅湖等资料中出现的地点，未确认实际到访，不进入路线地图。', linkedSpots: ['奇墅湖'], status: 'reference' }],
    accommodation: '有巢别院', accommodationSpotName: '有巢别院',
  ...
  },
  {
    ...
    accommodation: '新街口古南都弘嘉逸居酒店', accommodationSpotName: '新街口古南都弘嘉逸居酒店',
