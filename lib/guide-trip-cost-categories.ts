...
export const GUIDE_TRIP_COST_CATEGORIES = [
  ...
  { key: 'Food & Dining', nameEn: 'Food & Dining', nameZh: '餐饮', icon: 'Utensils', displayOrder: 4, description: 'Meals, drinks and ready-to-eat food', aliases: ['food', 'dining', 'meals', '餐饮', '饮食', '吃喝', '饮食 food & dining'] },
  { key: 'Tickets & Entrance Fees', nameEn: 'Tickets & Entrance Fees', nameZh: '门票', icon: 'Ticket', displayOrder: 5, description: 'Admission and entrance tickets', aliases: ['tickets', 'entrance fees', 'admission', '门票', '入场票', '门票 tickets / entrance fees', '门票 / 体验 tickets / entrance fees', '门票 & 套票'] },
  { key: 'Activities', nameEn: 'Activities', nameZh: '活动', icon: 'Sparkles', displayOrder: 6, description: 'Experiences, tours and activities', aliases: ['activities', 'activity', 'experiences', '活动', '体验', '活动 activities'] },
  { key: 'Internet & Communication', nameEn: 'Internet & Communication', nameZh: '通讯', icon: 'Wifi', displayOrder: 7, description: 'SIM, data and roaming', aliases: ['internet', 'sim card', 'mobile data', 'communication', '通讯', '通信', '网络'] },
  ...
  { key: 'Other', nameEn: 'Other', nameZh: '其他', icon: 'CircleEllipsis', displayOrder: 9, description: 'Confirmed travel spend not otherwise classifiable', aliases: ['other', 'others', '保险', '其他', '其他花费 others'] },
] as const
