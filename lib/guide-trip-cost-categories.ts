...
export const GUIDE_TRIP_COST_CATEGORIES = [
  ...
  { key: 'Tickets & Entrance Fees', nameEn: 'Tickets & Entrance Fees', nameZh: '门票', icon: 'Ticket', displayOrder: 5, description: 'Admission and entrance tickets', aliases: ['tickets', 'entrance fees', 'admission', '门票', '入场票', '门票 tickets / entrance fees', '门票 / 体验', '门票 / 体验 tickets / entrance fees', '门票 & 套票'] },
  ...
  { key: 'Internet & Communication', nameEn: 'Internet & Communication', nameZh: '通讯', icon: 'Wifi', displayOrder: 7, description: 'SIM, data and roaming', aliases: ['internet', 'sim card', 'mobile data', 'communication', '通讯', '通信', '网络', '通讯 internet & communication'] },
  ...
  { key: 'Other', nameEn: 'Other', nameZh: '其他', icon: 'CircleEllipsis', displayOrder: 9, description: 'Confirmed travel spend not otherwise classifiable', aliases: ['other', 'others', '保险', '其他', '其他 others', '其他花费 others'] },
] as const
