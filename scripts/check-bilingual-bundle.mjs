...
const required = ['data/location-slugs.json', 'data/guides.json', 'data/notes.json', 'public-data/locations.json', 'public-data/regions.json', 'public-data/guide-trip-costs.json']
