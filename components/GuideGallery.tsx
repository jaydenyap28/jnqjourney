...
export default function GuideGallery({
  ...
  return (
    <>
      <div className="mt-5">
        <p className="text-xs uppercase tracking-[0.2em] text-white/48">精选实拍</p>
      ...
      {activeIndex !== null ? (
        <div role="dialog" aria-modal="true" aria-label="攻略实拍图预览" className="fixed inset-0 z-[90] flex items-center justify-center bg-black/92 p-4">
